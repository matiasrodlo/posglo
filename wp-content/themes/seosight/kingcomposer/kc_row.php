...
$output             = $css_data           = $css                = $enable_particle_bg = '';
...
if ( $enable_particle_bg === 'yes' ) {
    $css_classes[] = 'kc_row_relative';
}
...
if ( $enable_particle_bg === 'yes' ) {
    $output .= '<div class="particles-js-wrap particles"></div>';
    wp_enqueue_script( 'particles' );
    wp_enqueue_script( 'partical-animation' );
}
