	...
	'stunning-show' => array(
		...
		'picker'  => array(
			'value' => array(
				...
				'value'        => 'yes',
				'desc'         => esc_html__( 'Panel after header will be show/hide from frontend', 'seosight' ),
			)
		),
		'choices' => array(
			'yes'  => array(
        ...
        'choices' => array(
            'image_bg' => array(
                'stunning_bg_image' => array(
                    ...
                    'value'   => seosight_get_old_stunning_options( 'customizer', 'stunning_bg_image' ),
                ...
                'stunning_bg_cover' => array(
                    'type'  => 'switch',
                    'value' => seosight_get_old_stunning_options( 'customizer', 'stunning_bg_cover' ),
